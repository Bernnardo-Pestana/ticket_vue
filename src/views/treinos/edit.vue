<template>
  <div>
      ...
      <div class="container px-4 mx-auto flex flex-wrap items-center justify-between">
        ...
        <div class="lg:flex flex-grow items-center hidden" id="example-collapse-navbar">
          <ul class="flex flex-col lg:flex-row list-none lg:ml-auto">
            <li class="nav-item">
              <a class="px-3 py-2 flex items-center text-xs uppercase font-bold leading-snug text-white hover:opacity-75" href="/treinos">
                <i class="fab fa-facebook-square text-lg leading-lg text-white opacity-75"></i><span class="ml-2">Treinos</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="px-3 py-2 flex items-center text-xs uppercase font-bold leading-snug text-white hover:opacity-75" href="/exercicios">
                <i class="fab fa-twitter text-lg leading-lg text-white opacity-75"></i><span class="ml-2">Exercicios</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="px-3 py-2 flex items-center text-xs uppercase font-bold leading-snug text-white hover:opacity-75" href="/usuario">
                <i class="fab fa-pinterest text-lg leading-lg text-white opacity-75"></i><span class="ml-2">Usuários</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="px-3 py-2 flex items-center text-xs uppercase font-bold leading-snug text-white hover:opacity-75" href="/treino_usuario">
                <i class="fab fa-pinterest text-lg leading-lg text-white opacity-75"></i><span class="ml-2">Treino ao Usuários</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="px-3 py-2 flex items-center text-xs uppercase font-bold leading-snug text-white hover:opacity-75" href="/cliente">
                <i class="fab fa-pinterest text-lg leading-lg text-white opacity-75"></i><span class="ml-2"> Visão do Aluno</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="px-3 py-2 flex items-center text-xs uppercase font-bold leading-snug text-white hover:opacity-75" href="/">
                <i class="fab fa-pinterest text-lg leading-lg text-white opacity-75"></i><span class="ml-2"> Página Inicial</span>
              </a>
            </li>
          </ul>
    ...
    <span class="text-sm text-gray-500"
      >Para salvar o Nome e a Serie do treino, clique em <b>Salvar</b> para salvar
      as alterações. 
    </span>
    <span class="text-sm text-gray-500">
      Para salvar a lista de exercicios, clique em <b>Salvar Exercicios</b> para salvar
      as alterações.
    </span>
  </div>
    ...
    <div class="flex justify-end mt-5 my-2">
    ...
    <div class="card shadow-sm border p-8 bg-white " v-if="listaExercicio">
    ...
    <div class="container px-6 pt-6">
        ...
        <form action="">
          <div class="grid md:grid-cols-3 gird-cols-1 gap-4 flex justify-center items-center">
            <div class="md:ml-auto md:mb-6">
              <p class="">
                <strong>Receber Notícias</strong>
              </p>
            </div>
      ...
      <div class="mb-6">
        <p>
          O Sistema de Gerenciamento de Academias foi criado para fácilitar 
          o professor na hora de passar seu treino e para que o aluno consiga
          visualizar seu treino de forma mais simples e rápida.
        </p>
      </div>
  ...
  <div class="mx-6 py-10 text-center md:text-left">
    <div class="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      <div class="">
        ...
        <p>
          O sistema foi inteiramente pensado da praticidade e agilidade para que 
          todos consiga um bom desempenho e que acabe com as fixinhas físicas
          dentros das academias.
        </p>
      </div>
      <div class="">
        ...
        <p class="mb-4">
          <a href="" class="text-gray-600">Vue.JS</a>
        </p>
        <p class="mb-4">
          <a href="" class="text-gray-600">Node.JS</a>
        </p>
        <p class="mb-4">
          <a href="" class="text-gray-600">CSS</a>
        </p>
        <p>
          <a href="" class="text-gray-600">JavaScript</a>
        </p>
      ...
      <div class="">
        ...
        <p class="flex items-center justify-center md:justify-start mb-4">
          ...
          alexjoaquimjr@gmail.com / bernardo.pestana@gmail.com
        </p>
        <p class="flex items-center justify-center md:justify-start mb-4">
        ...
        <p class="flex items-center justify-center md:justify-start mb-4">
          ...
          + 55 35 99235-8524 - Bernnardo Pestana
        </p>
      </div>
    </div>
  </div>
    ...
    <div class="text-center p-4" style="background-color: rgba(0, 0, 0, 0.2);">
      © 2021 Copyright:
      <a class="text-white" href="https://tailwind-elements.com/"> Gym Management</a>
    </div>
  </footer>
  </div>
</template>
